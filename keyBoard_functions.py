...
def createButton(parent, text, command, col,  width=8, style="big.TButton"):   
    ttk.Button(numberRow, text='~', command=lambda: press('~'), style="big.TButton", width=8).grid(row=0, column=col, padx=2, ipady=20)
...
numberKeys = ['~', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '7', '+', 'Bks']

for key in numberKeys:
    createButton(numberRow, key, lambda: press(key), numberKeys)
    # if(key == 'Bks'):
    #     createButton(numberRow, key, lambda: press(key), 21)
